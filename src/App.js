      ...
      <header>
        <div className="container flex-container">
            <div className="logo-header">
                <img src="./img/Logo.png" id="site-logo" alt="logo" />
            </div>
            ...
            <div className="why-choose-us-content">
                <div className="why-choose-us-text">
                    <div className="why-choose-us-features">
                        ...
                        <div className="icon">
                            <img src="./img/Modern.png" className="Modern_1" alt="Инструменты" />
                        </div>
                    </div>
                    <div className="why-choose-us-features">
                        <div className="text-part">
                        ...
                        <div className="icon">
                            <img src="./img/Unique.png" className="Unique_1" alt="Звезда" />
                        </div>
                    </div>
                </div>
                <div className="why-choose-us-armchair">
                    <img src="./img/Layer 14.png" className="armchair" alt="Кресло жёлтое" />
                </div>
                <div className="why-choose-us-text">
                    <div className="why-choose-us-features">
                        <div className="icon">
                            <img src="./img/Honest.png" className="Honest_2" alt="Карточка" />
                        </div>
                        <div className="text-part">
                    ...
                    <div className="why-choose-us-features">
                        <div className="icon">
                            <img src="./img/Support.png" className="Support_2" alt="Звонок" />
                        </div>
                        <div className="text-part">
      ...
      <section className="examples container grid-container">
        ...
        <div className="patio-example" id="patio-example">
            ...
            <div className="plane-example" id="plane-example">
                <img src="img/exampleplane.png" />

            </div>
            <div className="design-example" id="design-example">

                <img src="img/exampledesign.png" />
                <div className="example-description">
            ...
            <div className="ceramics-example" id="ceramics-example">
                <img src="img/exampleceramic.png" />
                <div className="example-description">
        ...
        <div className="container flex-container">
            <div className="item-collection">
                ...
                <a href="https://www.behance.net/gallery/51790647/PAHU-Free-PSD-Website-Template" target="_blank"
                    ...
                    <img className="new-chair" src="img/new.png" />
      ...
      <section className="our-designers">
        ...
        <div className="container flex-container">
            <div className="designer1">
                <img src="img/designer1.png" id="imgdes" />
                <p>Bertil Stam</p>
                <img src="img/chessfield.png" id="chessfield1" />
            </div>
            <div className="designer2">
                <img src="img/designer2.png" id="imgdes" />
                <p>Janet Park</p>
                <img src="img/chessfield.png" id="chessfield2" />
            </div>
            <div className="designer3">
                <img src="img/designer3.png" id="imgdes" />
                <p>Wm Munoz</p>
                <img src="img/chessfield.png" id="chessfield3" />
            </div>
        </div>
      </section>
        ...
        <div className="container">
            ...
            <div className="from-our-blog-posts">
                <div className="blog-post">
                    <img src="./img/our-new-workspace.png" />
                ...
                <div className="blog-post">
                    <img src="./img/modern-trend-collection.png" />
                    <div className="blog-post-text">
                ...
                <div className="blog-post">
                    <img src="./img/a-woman-thinking.png" />
                    <div className="blog-post-text">
            ...
            <div className="footer-info">
                <div className="footer-part logo-social-media">
                    ...
                    <div className="social-media">
                        ...
                        <a href="https://google.com" target="_blank">
                            <img src="./svg/google-plus.svg" alt="google plus" />
                        </a>
